                        ...
                        <div className="col-12 row justify-content-center">
                            <FormProvider {...methods}>
                                <form className="col-11" onSubmit={methods.handleSubmit(onSubmit)}>
                                    <CustomTextInput label="Contraseña Actual"
                                        name="Escriba su contraseña actual"
                                        rules={{ required: 'Este campo es obligatorio' }} />
                                    <CustomTextInput label="Contraseña Nueva"
                                        name="Escriba su contraseña nueva"
                                        rules={{ required: 'Este campo es obligatorio' }} />
                                    <CustomTextInput label="Repetir Contraseña Nueva"
                                        name="Repita su contraseña nueva"
                                        rules={{ required: 'Este campo es obligatorio' }} />
