        ...
        <div className="container-fluid my-2">
            <div className="row">
                <div className="col text-left">
                    <Link href="/matriculas/materias/create">
                ...
                <div className="row justify-content-center">
                    <div className="col-12 datatable-doc-demo">
                        ...
                        >
                            ...
                            <Column header="Horas Presenciales" field="horaPresencial" sortable filter />
                            <Column header="Descripción" field="descripcion" sortable filter />
                            <Column header="Objetivo" field="objetivo" sortable filter />
                            <Column header="Objetivo Específico" field="objetivoEspecifico" sortable filter />
                            {OptionesColumn({
